...
class PA3Expressions {
	public static void main(String[] whatever){
	        ...
	        // Integer addition
	        Meggy.setPixel( (byte)(2+1-3), (byte)(0+(3+4)) , Meggy.Color.VIOLET );
		Meggy.setPixel( (byte)(2+(1-3)), (byte)((0-3)+4) , Meggy.Color.VIOLET );
	        // Integer subtraction
	        ...
	        Meggy.setPixel( (byte)((byte)((byte)3-(byte)2)-(byte)1), 
                ...
                // Unary Minus
	        Meggy.setPixel((byte)(-5+5), (byte)((10*-5) +53), Meggy.Color.DARK);
                // watch it! spaces significant
Meggy.setPixel( (byte)( (byte)(0 - - - 6) * (byte)(-1)), (byte)((10+5)-8), Meggy.Color.ORANGE);
